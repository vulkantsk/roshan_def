...
LinkLuaModifier("modifier_imba_skull_basher", "items/item_skull_basher", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_skull_basher_unique", "items/item_skull_basher", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_skull_basher_bash", "items/item_skull_basher", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_skull_basher_skull_crash", "items/item_skull_basher", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_skull_basher_skull_break", "items/item_skull_basher", LUA_MODIFIER_MOTION_NONE)

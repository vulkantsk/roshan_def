...
LinkLuaModifier("modifier_imba_occult_mask", "items/item_occult", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_occult_mask_unique", "items/item_occult", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_occult_mask_unique:OnIntervalThink()
	if IsServer() then
		...
		for _,enemy in ipairs(enemies) do
			...
			if enemy:GetUnitName() ~= "npc_dota_sans" and not ignore_enemy then

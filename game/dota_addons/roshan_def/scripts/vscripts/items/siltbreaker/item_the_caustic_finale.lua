...
LinkLuaModifier( "modifier_item_the_caustic_finale", "items/siltbreaker/item_the_caustic_finale", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_sand_king_boss_caustic_finale", "items/siltbreaker/item_the_caustic_finale", LUA_MODIFIER_MOTION_NONE )

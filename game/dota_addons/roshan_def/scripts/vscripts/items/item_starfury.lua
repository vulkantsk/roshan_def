...
function ProjectileHit(params, projectileID, modifier)
	...
	ApplyDamage({attacker = params.hCaster, victim = params.hTarget, ability = nil, damage = params.damage, damage_type = params.damage_type, damage_flags = DOTA_DAMAGE_FLAG_USE_COMBAT_PROFICIENCY + DOTA_DAMAGE_FLAG_NO_SPELL_AMPLIFICATION})
end

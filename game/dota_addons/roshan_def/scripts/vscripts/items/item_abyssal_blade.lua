...
LinkLuaModifier("modifier_imba_abyssal_blade", "items/item_abyssal_blade", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_abyssal_blade_unique", "items/item_abyssal_blade", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_abyssal_blade_internal_cd", "items/item_abyssal_blade", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_abyssal_blade_bash", "items/item_abyssal_blade", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_abyssal_blade_skull_crash", "items/item_abyssal_blade", LUA_MODIFIER_MOTION_NONE)
...
function item_imba_abyssal_blade:OnSpellStart()
    ...
    if target:GetTeamNumber() ~= caster:GetTeamNumber() then
        if target:TriggerSpellAbsorb(ability) then
			...
			if target:GetUnitName()=="Spectre_boss" or target:GetUnitName()=="bh_boss"then
				return nil
			end       

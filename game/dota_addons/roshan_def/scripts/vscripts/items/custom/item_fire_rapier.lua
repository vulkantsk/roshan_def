...
function modifier_fire_rapier_fire_power_buff_penalty:DeclareFunctions()
...
function modifier_fire_rapier_fire_power_buff_penalty:IsHidden()
    return false
end

function modifier_fire_rapier_fire_power_buff_penalty:RemoveOnDeath()
    return true
end

...
-- Custom unique damage block property
function modifier_item_imba_poor_mans_shield:GetModifierPhysical_ConstantBlock()
...
function modifier_item_imba_poor_mans_shield:GetModifierBonusStats_Strength()
	return self.bonus_stats end

function modifier_item_imba_poor_mans_shield:GetModifierBonusStats_Agility()
	return self.bonus_stats end

function modifier_item_imba_poor_mans_shield:GetModifierBonusStats_Intellect()
	return self.bonus_stats end
...
if item_imba_vanguard_1 == nil then item_imba_vanguard_1 = class({}) end

function item_imba_vanguard_1:GetIntrinsicModifierName()
	return "modifier_item_imba_vanguard" end

if item_imba_vanguard_2 == nil then item_imba_vanguard_2 = class({}) end

function item_imba_vanguard_2:GetIntrinsicModifierName()
	return "modifier_item_imba_vanguard" end

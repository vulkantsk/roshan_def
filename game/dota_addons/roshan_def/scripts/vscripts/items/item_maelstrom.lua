...
if item_imba_maelstrom_2 == nil then item_imba_maelstrom_2 = class({}) end

function item_imba_maelstrom_2:GetIntrinsicModifierName()
	return "modifier_item_imba_maelstrom" end
...
if item_imba_mjollnir_2 == nil then item_imba_mjollnir_2 = class({}) end

function item_imba_mjollnir_2:GetIntrinsicModifierName()
	return "modifier_item_imba_mjollnir"
end

function item_imba_mjollnir_2:OnSpellStart()
	if IsServer() then
...
LinkLuaModifier( "modifier_item_imba_jarnbjorn", "items/item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )					-- Owner's bonus attributes, stackable
LinkLuaModifier( "modifier_item_imba_jarnbjorn_counter", "items/item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )			-- Attack proc counter
LinkLuaModifier( "modifier_item_imba_jarnbjorn_static", "items/item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )			-- Static shield
LinkLuaModifier( "modifier_item_imba_jarnbjorn_static_counter", "items/item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )	-- Shield proc counter
LinkLuaModifier( "modifier_item_imba_jarnbjorn_slow", "items/item_maelstrom.lua", LUA_MODIFIER_MOTION_NONE )				-- Shield slow

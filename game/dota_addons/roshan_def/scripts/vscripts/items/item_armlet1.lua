...
function modifier_item_imba_magic_armlet:GetModifierSpellAmplify_Percentage()
	return self:GetAbility():GetSpecialValueFor("bonus_magic_amp") end
...
--	Unholy Strength modifier definition
-----------------------------------------------------------------------------------------------------------
if modifier_imba_magic_armlet_power == nil then modifier_imba_armlet_unholy_strength = class({}) end
...
function modifier_imba_magic_armlet_power:GetModifierPreAttack_BonusDamage()		-- Static + stacks
	return self:GetAbility():GetSpecialValueFor("bonus_damage_buff") + self:GetStackCount() * self:GetAbility():GetSpecialValueFor("stack_damage")
end

function modifier_imba_magic_armlet_power:GetModifierSpellAmplify_Percentage()			-- Static + stacks
	return self:GetAbility():GetSpecialValueFor("bonus_magic_amp_buff") 
end

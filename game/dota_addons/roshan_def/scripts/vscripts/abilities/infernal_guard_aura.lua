...
LinkLuaModifier("modifier_cursed_aura", "abilities/infernal_guard_aura.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_cursed_aura_buff", "abilities/infernal_guard_aura.lua", LUA_MODIFIER_MOTION_NONE)
--------------------------------

infernal_guard_aura = class({})
LinkLuaModifier("infernal_guard_aura", "abilities/infernal_guard_aura", LUA_MODIFIER_MOTION_NONE)


function infernal_guard_aura:GetIntrinsicModifierName()
	return "modifier_cursed_aura"
end

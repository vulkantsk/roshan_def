LinkLuaModifier("modifier_sleight_of_fist_target_datadriven", 'abilities/thief/ability_thief_2.lua', LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sleight_of_fist_target_hero_datadriven", 'abilities/thief/ability_thief_2.lua', LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sleight_if_fist_target_creep_datadriven", 'abilities/thief/ability_thief_2.lua', LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sleight_of_fist_caster_datadriven", 'abilities/thief/ability_thief_2.lua', LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sleight_of_fist_dummy_datadriven", 'abilities/thief/ability_thief_2.lua', LUA_MODIFIER_MOTION_NONE)
-- test
LinkLuaModifier("modifier_sleight_of_fist_debuff_attackspeed", 'abilities/thief/ability_thief_2.lua', LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sleight_of_fist_debuff_movespeed", 'abilities/thief/ability_thief_2.lua', LUA_MODIFIER_MOTION_NONE)

ability_thief_2 = class({})

function ability_thief_2:GetAOERadius()
	return self:GetSpecialValueFor("radius")
end

function ability_thief_2:OnSpellStart()
	local keys = {
	...
	local dummy = CreateUnitByName( caster:GetUnitName(), caster:GetAbsOrigin(), false, caster, nil, caster:GetTeamNumber() )

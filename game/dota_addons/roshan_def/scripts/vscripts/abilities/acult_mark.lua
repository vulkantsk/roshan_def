LinkLuaModifier("modifier_acult_mark", "abilities/acult_mark", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_acult_mark_death", "abilities/acult_mark", LUA_MODIFIER_MOTION_NONE)

acult_mark = class({})

function acult_mark:GetIntrinsicModifierName()
	return "modifier_acult_mark"
end

modifier_acult_mark = class({
...
--	local newItem = CreateItem( "item_icefrog_stand", nil, nil )
	...
	if parent:GetUnitName() == "npc_dota_hero_pangolier" then
		...
		local demigod_enum ={
			...
			"npc_dota_hero_dragon_knight","npc_dota_hero_storm_spirit",
			"npc_dota_hero_chaos_knight","npc_dota_hero_juggernaut",
		}
		local data = {}

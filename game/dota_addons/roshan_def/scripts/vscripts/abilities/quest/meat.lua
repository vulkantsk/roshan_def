LinkLuaModifier("modifier_quest_meat", "abilities/quest/meat", LUA_MODIFIER_MOTION_NONE)

quest_meat = class({})

function quest_meat:GetIntrinsicModifierName()
	return "modifier_quest_meat"
end
--------------------------------------------------------
------------------------------------------------------------

modifier_quest_meat = class({
...
function modifier_quest_meat:OnCreated()
	if IsServer() then
		self:StartIntervalThink(0.1)
	end
end

function modifier_quest_meat:OnIntervalThink()
	...
	local quest_item = "item_meat"
	local reward_item = "item_reward_meat"
...
function modifier_quest_meat:GetEffectName()
	return "particles/generic_gameplay/generic_has_quest.vpcf"
end

function modifier_quest_meat:GetEffectAttachType()

...
function LoadGameKeyValues()
    ...
    local files = { AbilityKV = {base="npc_abilities",custom="greevil_lord/greevil_abilities"},
                    ItemKV = {base="items",custom="greevil_lord/greevil_items"},
                    UnitKV = {base="npc_units",custom="greevil_lord/greevil_units"},

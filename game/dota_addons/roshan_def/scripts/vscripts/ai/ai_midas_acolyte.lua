...
--	thisEntity:AddNewModifier( thisEntity, nil, "modifier_fow_vision", nil )
	...
	NoTargetAbility = thisEntity:FindAbilityByName( "ability_midas_acolyte_3" )

	thisEntity:SetContextThink( "MidasAcolyteThink", MidasAcolyteThink, 1 )
end

function MidasAcolyteThink()

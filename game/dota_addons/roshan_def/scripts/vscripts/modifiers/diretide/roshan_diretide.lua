...
LinkLuaModifier("modifier_imba_roshan_ai_diretide", "modifiers/diretide/roshan_diretide", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_roshan_ai_beg", "modifiers/diretide/roshan_diretide", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_roshan_ai_eat", "modifiers/diretide/roshan_diretide", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_roshan_eaten_candy", "modifiers/diretide/roshan_diretide", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_roshan_acceleration", "modifiers/diretide/roshan_diretide", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_roshan_death_buff", "modifiers/diretide/roshan_diretide", LUA_MODIFIER_MOTION_NONE)
...
function modifier_imba_roshan_ai_diretide:IsHidden() return false end

...
--	caster:SwapAbilities("aghs_greater_telekinesis", "aghs_greater_telekinesis_land", false, true)
--	caster:FindAbilityByName("aghs_greater_telekinesis_land"):UpgradeAbility(true)
end
...
function Drop(keys)
	...
	local telekinesis = keys.ability
	-- Chosen drop point
